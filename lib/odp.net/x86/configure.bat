...
echo.
echo xcopy ..\common\Oracle.ManagedDataAccess.Client.Configuration.Section.xsd "%VS120COMNTOOLS%\..\..\Xml\Schemas" /R /Y
if defined VS120COMNTOOLS xcopy ..\common\Oracle.ManagedDataAccess.Client.Configuration.Section.xsd "%VS120COMNTOOLS%\..\..\Xml\Schemas" /R /Y
echo xcopy ..\common\Oracle.ManagedDataAccess.Catalog.xml "%VS120COMNTOOLS%\..\..\Xml\Schemas" /R /Y
if defined VS120COMNTOOLS xcopy ..\common\Oracle.ManagedDataAccess.Catalog.xml "%VS120COMNTOOLS%\..\..\Xml\Schemas" /R /Y

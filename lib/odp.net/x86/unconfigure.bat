...
if EXIST "%VS120COMNTOOLS%..\..\Xml\Schemas\Oracle.ManagedDataAccess.Client.Configuration.Section.xsd" (
  echo.
  echo del "%VS120COMNTOOLS%..\..\Xml\Schemas\Oracle.ManagedDataAccess.Client.Configuration.Section.xsd" 
  del "%VS120COMNTOOLS%..\..\Xml\Schemas\Oracle.ManagedDataAccess.Client.Configuration.Section.xsd"
)
if EXIST "%VS120COMNTOOLS%..\..\Xml\Schemas\Oracle.ManagedDataAccess.Catalog.xml" (
  echo.
  echo del "%VS120COMNTOOLS%..\..\Xml\Schemas\Oracle.ManagedDataAccess.Catalog.xml" 
  del "%VS120COMNTOOLS%..\..\Xml\Schemas\Oracle.ManagedDataAccess.Catalog.xml"
)
